...
class UsersFixture extends TestFixture
{
    ...
    // phpcs:disable
    public $fields = [
        'userid' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        '_constraints' => [
            ...
            'FK_users' => ['type' => 'foreign', 'columns' => ['employeeid'], 'references' => ['employees', 'employeeid'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
